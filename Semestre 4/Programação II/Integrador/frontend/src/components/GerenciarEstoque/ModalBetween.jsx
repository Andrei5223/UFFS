...
const ModalBetween = (props) => {
    ...
    async function handleSubmit() {
        ...
        if (nome !== "" && qtd !== "") {
            ...
            props.setMessageText("Defina um bem e quantidade inicial e final!");
            ...
            <>
                <Box width={400} height={190} bgcolor={"background.default"} color={"text.primary"} padding={3} borderRadius={5}>
                    <Stack spacing={2}>
                        ...
                        <Typography>Defina o bem e a quantidade atual em estoque:</Typography>
