...
function App() {
    ...
    return (
        <div>
            <Grid container spacing={2} justifyContent="center" alignItems="center" style={containerPadding} className="containerStyles">
                <Grid item lg={3}>
            ...
            <Grid container spacing={2} justifyContent="center" style={containerPadding} className="containerStyles">
                <Grid item lg={6}>
