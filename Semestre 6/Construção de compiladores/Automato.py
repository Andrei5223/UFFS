...
gramatica = {
    ...
    6: glc("Expr", ["Expr", "Expr", "MAIS", "Termo"]),
...
slr = {
    0: {"ACTION": {"VAR": ("s", 5), "ENQUANTO": ("s", 7), "CHAD": ("r", 4), "$": ("r", 4)}, 
        "GOTO": {"Prog": 1, "Decl": 2, "Cond": 3, "Loop": 4}},
    1: {"ACTION": {"$": ("acc", 100)}, 
        "GOTO": {}},
    2: {"ACTION": {"VAR": ("s", 5), "ENQUANTO": ("s", 7), "CHAD": ("r", 4), "$": ("acc", 100)}, 
        "GOTO": {"Prog": 8, "Decl": 2, "Cond": 3, "Loop": 4}},
    3: {"ACTION": {"VAR": ("s", 5), "ENQUANTO": ("s", 7), "CHAD": ("r", 4), "$": ("r", 4)}, 
        "GOTO": {"Prog": 9, "Decl": 2, "Cond": 3, "Loop": 4}},
    4: {"ACTION": {"VAR": ("s", 5), "ENQUANTO": ("s", 7), "CHAD": ("r", 4), "$": ("r", 4)}, 
    ...
    13: {"ACTION": {"VAR": ("s", 19), "PARE": ("s", 17), "NUM": ("s", 18)}, 
        "GOTO": {"Expr": 21, "Termo": 15, "Fator": 16, "Vali": 23}},
    14: {"ACTION": {"PVIRGULA": ("s", 24), "MAIS": ("s", 25), "MENOS": ("s", 26)}, 
        "GOTO": {}},
    15: {"ACTION": {"ATRIB": ("r", 8), "PVIRGULA": ("r", 8), "MAIS": ("r", 8), "MENOS": ("r", 8), "MULTI": ("s", 27), "DIV": ("s", 28), "CHAD": ("r", 8), "MAIOR": ("r", 8), "MENOR": ("r", 8), "DIF": ("r", 8)}, 
        "GOTO": {}},
    16: {"ACTION": {"ATRIB": ("r", 11), "PVIRGULA": ("r", 11), "MAIS": ("r", 11), "MENOS": ("r", 11), "MULTI": ("r", 11), "DIV": ("r", 11), "CHAD": ("r", 11), "MAIOR": ("r", 11), "MENOR": ("r", 11), "DIF": ("r", 11)}, 
        "GOTO": {}},
    17: {"ACTION": {"VAR": ("s", 19), "PARE": ("s", 17), "NUM": ("s", 18)}, 
        "GOTO": {"Expr": 29, "Termo": 15, "Fator": 16}},
    18: {"ACTION": {"ATRIB": ("r", 13), "PVIRGULA": ("r", 13), "MAIS": ("r", 13), "MENOS": ("r", 13), "MULTI": ("r", 13), "DIV": ("r", 13), "CHAD": ("r", 13), "MAIOR": ("r", 13), "MENOR": ("r", 13), "DIF": ("r", 13)}, 
        "GOTO": {}},
    19: {"ACTION": {"ATRIB": ("r", 14), "PVIRGULA": ("r", 14), "MAIS": ("r", 14), "MENOS": ("r", 14), "MULTI": ("r", 14), "DIV": ("r", 14), "CHAD": ("r", 14), "MAIOR": ("r", 14), "MENOR": ("r", 14), "DIF": ("r", 14)}, 
        "GOTO": {}},
    20: {"ACTION": {"PARD": ("s", 30)},
        "GOTO": {}},
    21: {"ACTION": {"ATRIB": ("s", 31), "MAIS": ("s", 25), "MENOS": ("s", 26), "MAIOR": ("s", 32), "MENOR": ("s", 33), "DIF": ("s", 34)}, 
        "GOTO": {}},
    22: {"ACTION": {"VAR": ("s", 19), "PARE": ("s", 25), "NUM": ("s", 18)}, 
    ...
    28: {"ACTION": {"VAR": ("s", 19), "PARE": ("s", 17), "NUM": ("s", 18)}, 
        "GOTO": {"Fator": 41}},
    29: {"ACTION": {"MAIS": ("s", 25), "MENOS": ("s", 26), "NUM": ("s", 42)}, 
        "GOTO": {}},     
    30: {"ACTION": {"CHAE": ("s", 44)}, 
        "GOTO": {"Bloco": 43}},
    ...
    35: {"ACTION": {"PARD": ("s", 51)}, 
        "GOTO": {}},
    36: {"ACTION": {"ATRIB": ("s", 31), "MAIS": ("s", 25), "MENOS": ("s", 26), "PARD": ("s", 42), "MAIS": ("s", 42), "MENOS": ("s", 33), "DIF": ("s", 34)}, 
        "GOTO": {}},  
    37: {"ACTION": {"CHAE": ("s", 44)}, 
        "GOTO": {"Bloco": 52}},
